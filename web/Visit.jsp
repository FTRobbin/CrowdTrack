...
<html>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		...
		<div id="navbar" class="navbar-collapse collapse">
			...
			<jsp:include page="PrivilegeLevelHide.jsp" >
				...
				<jsp:param name="content" value="<li class=\"active\"><a href=\"Visit.jsp?searchAttribute=Visit&num=0\">New Visit</a></li>"/>
			</jsp:include>
	...
	<div class="container theme-showcase" role="main">    
		...
		<div class="panel-heading">
		    <h3 class="panel-title"> Already Visit</h3>
		</div>
	    ...
	    <%
                %> <h3> <%= "Suggestion POIs for " + request.getParameter("VisitPoi" + (n - 1)) + ": " %> </h3> <%
	    ...
	    <div class="panel panel-default">
		<div class="panel-heading">
		    <h3 class="panel-title">Visit POI</h3>
		</div>
		<div class="panel-body">
		    <form name="director_search" method=get onsubmit="return check_all_fields(this)" action="Visit.jsp">
			...
			<input type=hidden name="numberofheads<%= Integer.toString(i)%>" value="<%= request.getParameter("numberofheads" + i)%>">
			<% }%>
			POI Name:<input type=text name="VisitPoi<%= Integer.toString(n)%>" length=50>
