...
public class Visit {
    public static int doVisit(String login, String poiName, String visDate, int cost, int numberofheads) {
        try {
            SQLExecutor.executeUpdate("INSERT INTO acmdb05.VisEvent VALUES ( 0,"+cost+numberofheads+")");
            ArrayList<String[]> ret1 = SQLExecutor.executeQuery("SELECT LAST_INSERT_ID();");
            ...
            SQLExecutor.executeUpdate("INSERT INTO acmdb05.Visit VALUES ( '"+login+"',"+pid+","+vid+",'"+visDate+"')");
        } catch(Exception e) {
            e.printStackTrace();
            return 0;
        }
